...
ifstream Hard::fileopen(const string &filename)
{
...
void Hard::playGame()
{
    ...
    do
    {
        ...
        ifstream fileRead = fileopen("Hard.txt"); // this fucntion also calls the displayt function in it opens file and read it
        ...
        if (choice == 1)
        {
            ...
            if (!check)
            {
                ...
                outFile << userName << endl
                        << "Level 1 Hard - Time: " << level1Duration << " seconds" << " - Mistakes " << mistakes << endl;
                outFile.close();
        ...
        if (choice == 2)
        {
            ...
            if (!check2)
            {
                ...
                ofstream outFile("record.txt", ios::app);
                outFile << userName << endl
                        << "Level 2 Hard - Time: " << level2Duration << " seconds" << " - Mistakes " << mistakes << endl;
                outFile.close();
                colors(4);
        ...
        if (choice == 3)
        {
            ...
            if (!check3)
            {
                ...
                ofstream outFile("record.txt", ios::app);
                outFile << userName << endl
                        << "Level 3 Hard - Time: " << level3Duration << " seconds" << " - Mistakes " << mistakes << endl;
                outFile.close();
                fileRead.close();
            }
        }
