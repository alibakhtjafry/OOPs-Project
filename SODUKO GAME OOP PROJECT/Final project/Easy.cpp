...
void Easy::setMistakes(int n)
{
    mistakes = n;
}
int Easy::getMistakes()
{
    return mistakes;
}

ifstream Easy::fileopen(const string &filename)
{
...
// This fucntion contain all the main code for the execution of the game
void Easy::playGame()
{
    ...
    do
    {
        ...
        ifstream fileRead = fileopen("Easy.txt"); // this fucntion also calls the displayt function in it opens file and read it
        ...
        if (choice == 1)
        {
            ...
            if (!check)
            {
                ...
                outFile << userName << endl
                        << "Level 1 Easy - Time: " << level1Duration << " seconds" << " - Mistakes " << mistakes << endl;
                outFile.close();
        ...
        if (choice == 2)
        {
            ...
            if (!check2)
            {
                ...
                ofstream outFile("record.txt", ios::app);
                outFile << userName << endl
                        << "Level 2 Easy - Time: " << level2Duration << " seconds" << " - Mistakes " << mistakes << endl;
                outFile.close();
                colors(4);
        ...
        if (choice == 3)
        {
            ...
            if (!check3)
            {
                ...
                ofstream outFile("record.txt", ios::app);
                outFile << userName << endl
                        << "Level 3 Easy - Time: " << level3Duration << " seconds" << " - Mistakes " << mistakes << endl;
                outFile.close();
                fileRead.close();
            }
        }
